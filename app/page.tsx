      ...
      <div className="h-[calc(100vh-4rem)]  flex flex-col-reverse md:flex-row px-6 md:px-32">
        <div className="w-full md:w-1/2 flex items-center justify-center">
          <div className="text-center max-w-3xl px-4 md:px-0">
            ...
            <button
              onClick={handlePayment}
              className="bg-primary font-bold text-tertiary border-2 border-primary hover:text-primary hover:bg-secondary hover:border-primary px-4 md:px-6 py-3 rounded-lg hover:scale-105"
            >
              Get Started
            </button>
          </div>
